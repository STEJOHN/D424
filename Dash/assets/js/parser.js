...
export class TaskManager {
  ...
  getResolvedTasks() {
    return this.tasks.filter((task) => task.State === "Resolved");
  }
}
    ...
    Papa.parse(file, {
      ...
      complete: function (results) {
        ...
        loadPeopleData().then(() => {
          ...
          tasksByManager = countTasksByManager(getResolvedTasks(metro));
          taskManager.metro = metro;
          shift = findMostRecentDates(getResolvedTasks(metro));
